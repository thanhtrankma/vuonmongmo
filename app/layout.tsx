...
export const metadata: Metadata = {
  title: 'Vườn Mơ Màng - Nến Thơm Nghệ Thuật Từ Những Khu Vườn Đầy Cảm Hứng',
  ...
  keywords: 'nến thơm, nến nghệ thuật, vườn mơ màng, scented candles, decorative candles, vietnam candles',
  authors: [{ name: 'Vườn Mơ Màng' }],
  icons: {
  ...
  openGraph: {
    title: 'Vườn Mơ Màng - Nến Thơm Nghệ Thuật',
