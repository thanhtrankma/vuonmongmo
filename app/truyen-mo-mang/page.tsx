    ...
    <main className="py-16 md:py-24 bg-white">
      <div className="container mx-auto px-4 max-w-4xl">
        ...
        <section className="space-y-10 md:space-y-12">
          {candleStories.map((story, index) => (
            <ScrollReveal
              key={story.slug}
              direction={index % 2 === 0 ? 'left' : 'right'}
            >
              <article className="bg-gray-50 rounded-2xl overflow-hidden border border-gray-100 shadow-sm hover:shadow-md transition-shadow">
