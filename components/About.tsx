        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
          <div>
            ...
            <div className="space-y-4 text-gray-700 leading-relaxed">
              <p>
                Ở một góc nhỏ của thế giới, nơi thời gian trôi chậm lại, có một khu vườn chẳng bao giờ úa tàn. Ở đó, từng ngọn nến không chỉ tỏa sáng, mà còn kể những câu chuyện dịu dàng. Đó là Vườn mộng mơ – khu vườn được tạo nên từ ánh sáng, màu sắc và những giấc mơ.
              </p>
              <p>
              ...
              <p>
                🕯️ Hãy để Vườn mộng mơ mang đến cho bạn một khu vườn thu nhỏ trong ánh sáng – nơi giấc mơ nở hoa, nơi mỗi ngày đều có một chút phép màu! ✨💖
              </p>
            </div>
            
            <div className="mt-8 pt-8 border-t border-gray-200">
              <h4 className="text-xl font-semibold text-primary-700 mb-3">
                🌿✨ Vườn mộng mơ – Nến nghệ thuật từ những khu vườn đầy cảm hứng ✨🌿
              </h4>
              <p className="text-gray-700 leading-relaxed">
                Bộ sưu tập nến của Vườn mộng mơ là những khu vườn thu nhỏ, nơi ánh sáng hòa cùng sắc màu thiên nhiên, tạo nên những tác phẩm đầy cảm xúc. Từng ngọn nến không chỉ là vật trang trí, mà còn mang đến sự ấm áp, thư giãn và ý nghĩa sâu sắc.
              </p>
            </div>
          </div>
